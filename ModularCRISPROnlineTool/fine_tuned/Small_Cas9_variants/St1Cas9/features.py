...
TEST_GUIDE_LEN = 19
TEST_TARGET_LEN = 19
scaffold = "GUCUUUGUACUCUGGUACCAGAAGCUACAAAGAUAAGGCUUCAUGCCGAAAUCAACACCCUGUCAUUUUAUGGCAGGGUG"
...
def normalize_target(value):
    normalized_value = (value - (-50.50)) / (-28.91 - (-50.50))
    return normalized_value
...
def build_energy_features(guide, target):
    ...
    energy_array_unit = [normalize_guide(subopt_structures_guide[0].energy + 28.91)]
