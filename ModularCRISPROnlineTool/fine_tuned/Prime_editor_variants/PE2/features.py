...
TEST_GUIDE_LEN = 20
TEST_TARGET_LEN = 20
scaffold = "GUUUUAGAGCUAGAAAUAGCAAGUUAAAAUAAGGCUAGUCCGUUAUCAACUUGAAAAAGUGGCACCGAGUCGGUGCUUUUU"
...
def build_energy_features(guide, target):
    ...
    energy_array_unit = [normalize_guide(subopt_structures_guide[0].energy + 13.23)]
